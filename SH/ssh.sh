...
main_menu() {
    while true; do
        ...
        echo "${gl_lv}01.${gl_bai} 系統更新"
        echo "${gl_lv}02.${gl_bai} 系統清理"
        echo "${gl_lv}03.${gl_bai} 開啟 root 登錄"
        echo "${gl_lv}04.${gl_bai} 修改 root 密碼"
        echo "${gl_lv}05.${gl_bai} 修改 SSH 端口"
        echo "${gl_lv}04.${gl_bai} 更改時區"
        echo "${gl_lv}07.${gl_bai} 設定防火牆"
        echo "${gl_lv}08.${gl_bai} 配置 DNS"
        echo "${gl_lv}09.${gl_bai} 管理 BBR"
        echo "${gl_lv}10.${gl_bai} 管理 WARP"
        echo "${gl_lv}11.${gl_bai} 重啟 VPS"
        echo "${gl_lv}12.${gl_bai} 安裝 wget/unzip"
        echo "${gl_lv}13.${gl_bai} 安裝 Acme"
        echo "${gl_lv}14.${gl_bai} 安裝 Snell"
        echo "${gl_lv}15.${gl_bai} 安裝 Mihomo"
        echo "${gl_lv}16.${gl_bai} 安裝 Trojan"
        echo "${gl_lv}17.${gl_bai} 安裝 Hysteria"
        echo "${gl_lv}18.${gl_bai} 安裝 SubStore"
        echo "${gl_lv}19.${gl_bai} 一键 DDSystem"
        echo "${gl_lv}20.${gl_bai} 反代 Nginx"
        echo "${gl_lv}21.${gl_bai} 超级 Snell"
        echo "${gl_lv} 0.${gl_bai} 離開 El Psy Kongroo"
