...
main_menu() {
    while true; do
        ...
        echo "${gl_lv}01.${gl_bai} 系統更新${gl_bai}"
        echo "${gl_lv}02.${gl_bai} 系統清理${gl_bai}"
        echo "${gl_lv}03.${gl_bai} 開啟 root 登錄${gl_bai}"
        echo "${gl_lv}04.${gl_bai} 修改 root 密碼${gl_bai}"
        echo "${gl_lv}05.${gl_bai} 修改 SSH 端口${gl_bai}"
        echo "${gl_lv}04.${gl_bai} 更改時區${gl_bai}"
        echo "${gl_lv}07.${gl_bai} 設定防火牆${gl_bai}"
        echo "${gl_lv}08.${gl_bai} 配置 DNS${gl_bai}"
        echo "${gl_lv}09.${gl_bai} 管理 BBR${gl_bai}"
        echo "${gl_lv}10.${gl_bai} 管理 WARP${gl_bai}"
        echo "${gl_lv}11.${gl_bai} 重啟 VPS${gl_bai}"
        echo "${gl_lv}12.${gl_bai} 安裝 wget/unzip${gl_bai}"
        echo "${gl_lv}13.${gl_bai} 安裝 Acme${gl_bai}"
        echo "${gl_lv}14.${gl_bai} 安裝 Snell${gl_bai}"
        echo "${gl_lv}15.${gl_bai} 安裝 Mihomo${gl_bai}"
        echo "${gl_lv}16.${gl_bai} 安裝 Trojan${gl_bai}"
        echo "${gl_lv}17.${gl_bai} 安裝 Hysteria${gl_bai}"
        echo "${gl_lv}18.${gl_bai} 安裝 SubStore${gl_bai}"
        echo "${gl_lv}19.${gl_bai} 一键 DDSystem${gl_bai}"
        echo "${gl_lv}20.${gl_bai} 反代 Nginx${gl_bai}"
        echo "${gl_lv}21.${gl_bai} 超级 Snell${gl_bai}"
        echo  "${gl_lv}0.${gl_bai} 離開 El Psy Kongroo${gl_bai}"
